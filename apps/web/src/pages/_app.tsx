  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="twitter:image"
          content="https://icecreamswap.com/images/hero.png"
        />
        <meta
      ...
      <main>
        <Providers store={store}>
          <SupportedChainsProvider
            supportedChains={
              (props as AppPropsWithLayout).Component.chains || CHAIN_IDS
            }
          >
            <Blocklist>
...
const App = ({ Component, pageProps }: AppPropsWithLayout) => {
  ...
  const wrongChain =
    typeof chainId !== "undefined" && !supportedChains.includes(chainId);
  if (Component.pure) {
