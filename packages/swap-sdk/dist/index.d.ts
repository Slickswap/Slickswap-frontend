...
declare const WETH9: Record<number, ERC20Token>;
...
export { BestTradeOptions, ERC20Token, FACTORY_ADDRESS_MAP, INIT_CODE_HASH_MAP, NATIVE, Native, Pair, Route, Router, SwapParameters, Trade, TradeOptions, TradeOptionsDeadline, WETH9, WNATIVE, computePairAddress, computePriceImpact, inputOutputComparator, tradeComparator };
